namespace Mega.Tests.Services
{
    ...
    internal class ZadolbaliClientTests
    {
        ...
        public async Task EmptyTagsTest()
        {
            ...
            var article = (await new ZadolbaliClient(Task.FromResult, Task.FromResult).GetArticles(body)).First();
        ...
        public async Task EmptyTextTest()
        {
            ...
            Assert.AreEqual(0, (await new ZadolbaliClient(Task.FromResult, Task.FromResult).GetArticles(body)).Count);
        }
        ...
        public async Task GetTagsTest()
        {
            ...
            var tags = await new ZadolbaliClient(Task.FromResult, async _ => body).GetTags();
        ...
        public async Task GenerateIdTest()
        {
            ...
            var dates = await new ZadolbaliClient(Task.FromResult, async _ => body).GenerateIDs();
