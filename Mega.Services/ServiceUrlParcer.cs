...
{
    public class ServiceUrlParcer
    {
        private static ILogger Logger { get; } = ApplicationLogging.CreateLogger<ServiceUrlParcer>();
        ...
        public ServiceUrlParcer(MessageBroker<UriLimits> messages, MessageBroker<UriBody> reports, MessageBroker<UriLimits> articles, int checkDepth = -1)
        {
